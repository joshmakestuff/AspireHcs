...
6. [x] Reproducible Windows guest base image builder — ISO to sealed, CoW-friendly VHDX ([#11](https://github.com/joshmakestuff/AspireHcs/issues/11)). Now lives in [hcsimgtool](https://github.com/joshmakestuff/hcsimgtool) under `tools/guest-images/windows`.
